...
abstract class AbstractStepDefinitions {
     ...
     */
    @NotNull
    protected static String payload(final @NotNull String resourceName) {
    ...
    /**
     * Loads a resource file, under "response" resource directory, as a {@code String} object given that resource file
     * name.
     *
     * @param resourceName  The specified resource file name
     *
     ...
     */
    @NotNull
    protected static String response(final @NotNull String resourceName) {
        return resource("response", resourceName);
    }
     ...
     */
    @NotNull
    protected static String resource(final @NotNull String resourceDirPath, final @NotNull String resourceFilename) {
